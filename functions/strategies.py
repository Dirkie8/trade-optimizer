"""
All trading strategies for the optimizer.

Add new strategy classes here to make them available for optimization.
Each strategy must inherit from BaseStrategy and implement generate_signals().
"""
import pandas as pd
...
# Example: Add more strategies here
# class RSIStrategy(BaseStrategy):
#     """RSI-based mean reversion strategy."""
#
#     def generate_signals(self) -> Tuple[Action, Optional[float], Optional[float]]:
#         period = int(self.config["rsi_period"])
...
#
#         # Calculate RSI...
#         # if rsi < oversold: return "BUY", sl_pips, tp_pips
#         # elif rsi > overbought: return "SELL", sl_pips, tp_pips
#         # else: return "HOLD", None, None
#         pass
